...
(defrule grab-object-from-ladder "" 
  ...
  =>
  (printout t "Monkey grabs the " ?name ".")
  (Break)
...
(defrule drop-object ""  
  ...
  =>
  (printout t "Monkey drops the " ?name ".")
  (Break)
  (modify ?monkey (holding blank))
...
(defrule walk-holding-nothing ""
  ...
  =>
  (printout t "Monkey walks to " ?place ".")
  (Break)
...
(defrule walk-holding-object ""
  ...
  =>
  (printout t "Monkey walks to " ?place " holding the " ?obj ".")
  (Break)
  (modify ?monkey (location ?place))
  (retract ?goal))
...
(defrule jump-onto-floor "" 
  ...
  =>
  (printout t "Monkey jumps off the " ?on " onto the floor.")
  (Break)
...
(defrule climb-directly ""  
  ...
  ?monkey <- (monkey (location ?place) (on-top-of ?on) (holding blank))
  =>
  (printout t "Monkey climbs onto the " ?obj ".")
  (Break)
...
(defrule satisfy-hunger ""
  ...
  ?thing <- (thing (name ?name))
  =>
  (printout t "Monkey eats the " ?name ".")
  (Break)
  (modify ?monkey (holding blank))
  (retract ?goal ?thing))
